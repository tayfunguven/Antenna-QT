...
from calculation import AnalogConversion
...
class Ui_MainWindow(QObject):
    ...
    def up(self):
        ...
        self.object_write.write_multiple_registers(0, write_command_list)
        self.object_read.close()
...
class ModbusWorker(QObject):
    ...
    def modbus_read(self):
        ...
        while True:
            list = self.object_read.read_input_registers(0, 26)
            az_val = list[12]
            el_val = list[5]
